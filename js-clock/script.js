...
// display self-check results in the console

console.log(`
          Результаты самопроверки:
            1. Разобраться в коде чужого проекта, понять его, воспроизвести исходное приложение.
                Правки приветствуются, если они не ухудшают внешний вид и функционал исходного проекта - 10 баллов (выполнено);
            2. Дополнить проект обязательным функционалом, указанным в описании задания - 10 баллов (выполнено);
            3. Дополнить проект дополнительным функционалом на выбор из тех, которые перечислены в описании задания.
                ...
                Реализовано 2 улучшения: круговые диаграммы и переключение темы (тёмная / светлая) - 20 баллов (выполнено);
          Итого: 40 баллов за проделанную работу.
          Т.к. максимум баллов за задание 30, то и результат выполнения задания 30 баллов.
`);